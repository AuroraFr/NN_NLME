...
class Antibody(eqx.Module):
    ...
    def __init__(self, latent_shape, init_params, key, n_z=1, T=100, timepoints=10, kernel_size=3,
        ...
        self.deltaS = jax.lax.cond(self.has_deltaS, lambda _: init_params[5], lambda _: jnp.log(0.01), None)
        self.deltaAB = jax.lax.cond(len(init_params) == 8, lambda _: init_params[6], lambda _: jnp.log(0.08), None)
    ...
    def _sample(self, latent, times):
        ...
        def solve(individual_theta, individual_F2):
            ...
            # print(Ab_degrad_rate, death_rate_S_cell)
