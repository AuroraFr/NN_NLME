...
def main(i, steps=55000):
    ...
    init_params = np.loadtxt('antibody_datasets/antibody3doses_deltaAB_identifiability_initparams.txt')

    if irregular:
        model_folder = './EXPs/exp_antibody_3dose_2latent/irregular_identifiability_'+str(time_length)+'p_400d_50s_deltaS_noise_2latent_theta_F2/'
    else:
