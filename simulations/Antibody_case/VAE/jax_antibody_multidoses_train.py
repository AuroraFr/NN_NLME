...
def main(i, steps=50000):
    ...
    if irregular:
        ...
        train_data = np.load('antibody_datasets/scipy_antibody_irregular_3dose/'+str(measurements)+'_400_50_2latent_theta_F2/dataset_'+str(i)+'.npy')[:,:,1]
        train_data_timepoints = np.load('antibody_datasets/scipy_antibody_irregular_3dose/'+str(measurements)+'_400_50_2latent_theta_F2/dataset_timepoints_'+str(i)+'.npy')
        test_data = np.load('antibody_datasets/scipy_antibody_irregular_3dose/'+str(measurements)+'_400_50_2latent_theta_F2/dataset_0.npy')[:,:,1]
        test_data_timepoints = np.load('antibody_datasets/scipy_antibody_irregular_3dose/'+str(measurements)+'_400_50_2latent_theta_F2/dataset_timepoints_0.npy')
        ...
        train_data = np.load('antibody_datasets/scipy_antibody_3dose/10_400_50_2latent_theta_F2/dataset_'+str(i)+'.npy')[:,:,1]
        # train_data = np.load('antibody_datasets/scipy_antibody_3dose_1/dataset'+str(i)+'.npy')
        time_length = train_data.shape[1]
        print("regular sampling", time_length, train_data.shape)
        data_timepoints = jnp.linspace(0, T, time_length)
        # train_data_timepoints = np.array([0, 20, 45, 85, 130, 200, 260, 310, 350, 400])
        test_data = np.load('antibody_datasets/scipy_antibody_3dose/10_400_50_2latent_theta_F2/dataset_0.npy')[:,:,1]
        # test_data = np.load('antibody_datasets/scipy_antibody_3dose_1/dataset0.npy')
    ...
    if irregular:
        model_folder = './EXPs/exp_antibody_3dose_2latent/irregular_'+str(time_length)+'p_400d_50s_deltaAB_noise_2latent_theta_F2/'
    else:
        model_folder = './EXPs/exp_antibody_3dose_2latent/'+str(time_length)+'p_400d_50s_2latent_theta_F2/'
