...
if not irregular:
    data_folder = "antibody_datasets/scipy_antibody_3dose_2/15_400_50_2latent_theta_F2/"
    ...
    for i in range(10):
        ...
        plt.scatter(timepoints, dataset[i, :, 1])
        # plt.scatter(timepoints, dataset_2[i, :])
        plt.plot(timepoints, dataset_nonoise[i, :, 1])
    ...
    plt.savefig('figures/antibody_data_compare'+str(measurements)+'_50_400_3doses.pdf')
