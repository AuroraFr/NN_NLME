...
data_folder = 'data/antibody_datasets/antibody_regular_3doses/antibody_3dose_15_400_50/'
model_folder='trained_models/antibody_regular_3doses_2latent/'
variance_folder = 'variances/antibody_regular_'+str(b_sample_size)+'/'
estimated_params_file = 'results/antibody_pointwise_regular_results.txt'
